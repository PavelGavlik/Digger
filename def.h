...
#define FIREBALLS 2
#define SPRITES (DIGGERS+MONSTERS+EMERALDS+BAGS+COINS+BONUSES+FIREBALLS-2+STATICS+BACKGROUNDS)
...
#define FIRSTSTATIC LASTBONUS
#define LASTSTATIC (FIRSTSTATIC+STATICS)
#define FIRSTBACKGROUND LASTSTATIC
