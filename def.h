...
#define SPRITES (DIGGERS+MONSTERS+EMERALDS+BAGS+COINS+BONUSES+FIREBALLS+BACKGROUNDS)
...
#define FIRSTCOIN LASTBAG
#define LASTCOIN (FIRSTCOIN+COINS)
#define FIRSTBONUS LASTCOIN
