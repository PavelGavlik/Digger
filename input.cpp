...
static int16_t dynamicdir = -1, dynamicdir2 = -1, staticdir = -1, staticdir2 =
	-1, joyx = 0, joyy = 0;

static bool joybut1 = false/*, joybut2 = false*/;

static int16_t keydir = 0, keydir2 = 0, jleftthresh = 0, jupthresh =
	0, jrightthresh = 0, jdownthresh = 0, joyanax = 0, joyanay = 0;
...
void checkkeyb(void)
{
	int i, j, k = 0;
	bool *aflagp[10] =
		{ &arightpressed, &auppressed, &aleftpressed, &adownpressed,
...
void flushkeybuf(void)
{
	while (kbhit())
		getkey();
	aleftpressed = arightpressed = auppressed = adownpressed = af1pressed =
		false;
...
bool ou2pressed = false, od2pressed = false, ol2pressed = false, or2pressed =
	false;
